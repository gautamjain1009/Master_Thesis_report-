...
\end{figure}
    ...
    \textbf{Example 2: Full padding padding, unit strides} 
    In this case the size of output feature map after convolving the kernel. 
      \begin{figure}[h]
    \centering
    ...
    \textbf{Example 3: Half padding, unit strides}
